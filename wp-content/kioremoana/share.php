...
<button class="share-btn"><?php _e( 'Share This', 'kioremoana' ); ?></button>
<div class="share-links-wrap">
	<ul>
		<li class="twitter"><a href="http://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-url="<?php the_permalink(); ?>" data-text="<?php the_title(); ?>" data-lang="<?php bloginfo('language'); ?>"><?php _e('Tweet', 'kioremoana') ?></a></li>
